...
'''
用一台macBook pro跑data_analysis.py 跑了5天才完成2w条数据
*******************************
用的tensorflow GPU加速跑的，用cpu确实很慢...
'''
train = pd.read_csv('/data/barnett007/ctr-data/train.csv',chunksize=20000)
test = pd.read_csv('/data/barnett007/ctr-data/test.csv',chunksize=20000)
